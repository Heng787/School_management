...
const KpiCard = ({ title, value, trend, subValue, badge, icon }) => (
  <div className="bg-white dark:bg-slate-900 p-4 sm:p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-card hover:shadow-md transition-all duration-300 relative overflow-hidden group">
...
const MiniCalendar = () => {
  ...
  return (
    <div className="bg-white dark:bg-slate-900 p-5 rounded-xl border border-slate-200 dark:border-slate-800 shadow-card h-full transition-colors duration-300">
      ...
      <div className="mt-4 pt-4 border-t border-slate-100 dark:border-slate-800">
        <p className="text-xs text-slate-400 font-medium mb-2 uppercase">
          Today's Focus
        </p>
...
const DashboardPage = ({ navigate }) => {
  // --- 3.1. STATE & DATA ---
  const { students, subjects, classes, staff, enrollments, currentUser } =
    useData();
  ...
  return (
    <div className="max-w-7xl mx-auto space-y-6">
      <div className="flex justify-between items-end">
        ...
        <div className="text-sm font-medium text-slate-500 dark:text-slate-400 bg-white dark:bg-slate-900 px-3 py-1.5 rounded-lg border border-slate-200 dark:border-slate-800 shadow-sm flex items-center space-x-2 transition-colors duration-300">
