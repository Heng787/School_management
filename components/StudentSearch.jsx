        ...
        <div className="relative w-full max-w-md" ref={searchRef}>
            <div className="relative group">
                 <span className="absolute inset-y-0 left-0 flex items-center pl-3">
                    <svg className="w-5 h-5 text-slate-400 group-focus-within:text-primary-500 transition-colors" viewBox="0 0 24 24" fill="none">
                ...
                <input
                    ...
                    className="w-full py-2 pl-10 pr-4 text-slate-800 bg-slate-50 border border-slate-300 rounded-lg hover:bg-slate-100 focus:bg-white focus:outline-none focus:ring-2 focus:ring-primary-500 focus:border-primary-500 transition-all placeholder:text-slate-400 shadow-sm"
                />
            </div>
            {isOpen && (
